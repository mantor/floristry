...
class LeafExpressionTest < ActiveSupport::TestCase
  ...
  test "it parses Stall params" do
    ...
    stall = Floristry::Stall.new('test-u0-test', 'test', params, [], 'present')
  ...
  test "it parses Sleep params" do
    ...
    sleep = Floristry::Sleep.new('test-u0-test', 'test', params, [], 'present')
  ...
  test "it parses Set params" do
    ...
    set = Floristry::Set.new('test-u0-test', 'test', params, [], 'present')
  ...
  test "it parses a Task params" do
    ...
    task = Floristry::Task.new('test-u0-test', 'test', params, [], 'present')
  ...
  test "it accesses a Task payload" do
    ...
    task = Floristry::Task.new('test-u0-test', 'test', params, {ret: nil, task_tstamp:"1111-11-11 11:11:11 -0400"}, 'present')
