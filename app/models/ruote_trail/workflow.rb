module RuoteTrail
  class Workflow < RuoteTrail::BranchExpression
    ...
    def initialize(id, trail)
      ...
      mixin = RuoteTrail.configuration.add_workflow_behavior
    ...
    #
    # TODO could/should this be done using the trail?
    #
    def current_pos
      ...
      unless @current_expids
        ...
        p = RuoteTrail::WorkflowEngine.process(wfid)
    ...
    def factory(feid, era, exp)
      ...
      if is_expression? (klass_name)
        ...
        RuoteTrail.const_get(klass_name).new(feid, name, params, fields, era)
      else
